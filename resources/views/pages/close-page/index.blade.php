      ...
      <div class="row">
          <div class="col-lg-12">
              <div class="text-center">
                    ...
                    <h4 class="mt-5 text-uppercase text-white">Pendaftaran siswa baru telah ditutup</h4>
                    <p class="mb-0 text-white">Akan dibuka sesuai dengan waktu yang telah ditentukan</p>

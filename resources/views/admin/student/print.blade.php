  ...
  <body>
    <div class="container-fluid">
      ...
      <div class="">
        ...
        <div class="text-uppercase text-center fw-semibold float-start" style="margin-left: 98px; margin-right: 98px;">
      ...
      <section class="row mt-5 mb-5">
        <div class="col-12">
          <div>
            <div class="float-start" style="margin-left: 90px;">
              <!-- Foto Atau QR-Code -->
              @if ($data->foto)
            ...
            <div class="text-center">
              <p class="mb-0">Ciamis, {{ \Carbon\Carbon::now()->locale('id')->isoFormat('DD MMMM YYYY') }}</p>
              <p class="mb-0" style="margin-top: -5px;">Tanda Tangan</p>
              <p class="mb-0" style="margin-top: -5px;">Orang Tua/Wali Murid</p>
              <div style="padding-top: 75px; display: inline-block;">......................................</div>
            </div>
          </div>
        </div>
      </section>
